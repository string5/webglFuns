...
(function ()
{
	...
	mat4.prototype.rotate = function (theta, vector)
	{
	...
	mat4.makeScale = function (vector)
	{
	...
	mat4.makeTranslate = function (vector)
	{
	...
	var vector = function ()
	{
		this.elements = new glMatrixArrayType(arguments[0] || [0, 0, 0]);
		return this;
	};
